...
export default function BeliefSection() {
  return (
    <section className="max-w-[42em] mx-auto px-5 sm:px-8 md:px-12 py-40 md:py-48 bg-white">
      <motion.div
        {...MICRO.scrollReveal}
        variants={fadeUp}
        initial="hidden"
      ...
      >
        ...
        <p className="text-xl sm:text-2xl text-[#3E2723] leading-[2.0] tracking-[-0.02em]">
          我们记录训练，
          <br />
          不是为了证明努力。
        </p>

        <p className="text-xl sm:text-2xl text-[#3E2723] leading-[2.0] mt-8 tracking-[-0.02em]">
          而是希望每一次坚持，
          <br />
          都能被时间看见。
        </p>
        ...
        <div className="mt-20 flex justify-center gap-16">
          <div>
            <p className="text-4xl sm:text-5xl font-bold text-[#3E2723] tracking-[-0.02em]"
