...
export default function ContactSection() {
  return (
    <section id="contact" className="max-w-4xl mx-auto px-5 sm:px-8 md:px-12 py-40 md:py-48 bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center">
            ...
            <div className="w-40 h-40 mx-auto rounded-3xl flex items-center justify-center mb-4"
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto rounded-xl bg-white/60 flex items-center justify-center mb-2">
          ...
          <div className="text-center md:text-left">
            ...
            <h3 className="text-2xl font-semibold text-[#3E2723] tracking-[-0.02em] leading-[1.15] mb-4">直接联系</h3>
